...
from gym_pybullet_drones.control.vartools.directional_space import (
    get_angle_space,
...
from gym_pybullet_drones.control.dynamic_obstacle_avoidance.utils import get_tangents2ellipse
