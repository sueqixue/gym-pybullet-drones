...
def obs_avoidance_interpolation_moving(
    ...
    if rel_velocity_norm:
        ...
        rel_velocity_normalized = np.zeros(2,)
    ...
    for n in np.arange(N_obs)[ind_obs]:
        ...
        #convert relative_velocity to normal to obstacle and tangent to obstacle directions
            ...
            if len(velocity_limit) ==1:
                ...
                if isFailure:
                    return np.zeros(2,), True
                relative_velocity_hat[:, n] = new_velocity-xd_obs
                ...
                # if (relative_velocity_hat[0, n]>velocity_limit[0]+0.01) or (relative_velocity_hat[1, n]>velocity_limit[1]+0.01):
                #     print("here2")
                #     print(relative_velocity_hat_magnitude[n])
                #     print()
    ...
    # if (np.linalg.norm(vel_final)>velocity_limit[0]+0.1):
    #     print("here1")
    #     print(np.linalg.norm(vel_final))
